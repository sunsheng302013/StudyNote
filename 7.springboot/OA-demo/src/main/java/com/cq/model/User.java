...
public class User {
    ...
    public String toString() {
        return "User [userId=" + userId + ", userName=" + userName + ", password=" + password + ", email=" + email + ", mobile=" + mobile + ", realName="
                + realName + ", mainDepartId=" + mainDepartId + ", mainDepartName=" + mainDepartName + ", positionId=" + positionId + ", positionName="
                + positionName + ", leaderDepartId=" + leaderDepartId + ", leaderDepartName=" + leaderDepartName + ", leaderUserId=" + leaderUserId
                + ", leaderUserName=" + leaderUserName + ", leaderPositionId=" + leaderPositionId + ", leaderPositonName=" + leaderPositonName + ", gmtCreate="
