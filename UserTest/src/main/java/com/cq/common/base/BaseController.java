...
public class BaseController {
     ...
     */
    public static <T> JackYunResponse<T> sendSuccessData(T data, PageInfo pageInfo) {
    ...
    public static <T> JackYunResponse<T> sendSuccessData(T data) {
        return sendSuccessData(data, null);
    }
    ...
    public static <T> JackYunResponse<T> sendSuccess() {
        return sendSuccessData(null, null);
    }
     ...
     * @return 架构组规定JackYunResponse结构体
     */
    public static <T> JackYunResponse<T> sendFailure(ServiceException serviceException) {
        return sendFailure(serviceException.getResultCode().getCode(), serviceException.getResultCode().getMsg(), null);
    }
