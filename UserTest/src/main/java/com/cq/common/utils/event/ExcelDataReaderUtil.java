...
public class ExcelDataReaderUtil {
    ...
    public static void readExcel(IExcelRowReader reader, String urlName) throws Exception {
        ...
        try {
            /**
             * URL url = new URL(urlName); URLConnection connection = url.openConnection(); ins =
             * connection.getInputStream();
             **/

            // File excelFile = new File(urlName);
            ins = new FileInputStream(urlName);
